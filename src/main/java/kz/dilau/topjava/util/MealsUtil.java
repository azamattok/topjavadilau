package kz.dilau.topjava.util;

import kz.dilau.topjava.model.Meal;
import kz.dilau.topjava.model.MealTo;
...
public class MealsUtil {
   ...
   /* List<MealTo> mealsTo = filterByPredicate(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
    ...
    private static MealTo createTo(Meal meal, boolean excess) {
        return new MealTo(meal.getId(), meal.getDateTime(), meal.getDescrition(), meal.getCalories(), excess);
    }
}
